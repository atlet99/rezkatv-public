!(function () {
        ...
        (r = [
          {
            ...
            value: function (e) {
              ...
              if (!window.PalmServiceBridge) {
                ...
                return (b(h), p(h), console.error('PalmServiceBridge is not found.'), this)
              }
              this.ts && u[this.ts] && delete u[this.ts]
              var O,
                g = (function (e) {
              ...
              return (
                ...
                (this.bridge.onservicecallback = this.callback.bind(this, f, b, p)),
                this.bridge.call(
                  ('/' !== (O = t).slice(-1) && (O += '/'), O + c),
                  JSON.stringify(g)
),
            ...
            value: function () {
              ...
              if (!this.cancelled) {
                ...
                var i = o,
                  u = i.errorCode,
                  c = i.returnValue
                ;(u || !1 === c ? ((o.returnValue = !1), r(o)) : ((o.returnValue = !0), e(o)),
                  t(o),
  ...
  var y = {
    ...
    h = { PLAYREADY: 'playready', WIDEVINE: 'widevine' },
    O = function (e) {
      var r = e.method,
        t = e.parameters,
        n = e.onComplete
    ...
    w = function (e, r) {
      var t = r.errorCode,
        n = void 0 === t ? y.UNKNOWN_ERROR : t,
        o = r.errorText,
        i = { errorCode: n, errorText: void 0 === o ? 'Unknown error.' : o }
      return (e.setError(i), i)
    },
    P = { errorCode: y.CLIENT_NOT_LOADED, errorText: 'DRM client is not loaded.' },
    T = (function () {
      return (
        (e = function e(r) {
          ;(!(function (e, r) {
                  ...
                  O({
                    ...
                    onComplete: function (e) {
                      return !0 === e.returnValue
                        ? ((r.clientId = e.clientId), (r.state = 2), n({ clientId: r.clientId }))
                        : i(w(r, e))
                    },
                    parameters: u
}))
              } else g(n, { isLoaded: !0, clientId: this.clientId })
            }
},
          {
            key: 'unload',
            ...
            value: function (e) {
              ...
              if (S(this)) {
                var a = (function (e) {
                  ...
                  s = v({ clientId: this.clientId, msg: n }, a)
                O({
    ...
    C = function (e) {
      ...
      ;-1 !== navigator.userAgent.indexOf('Chrome')
        ? new c().send({
            ...
            onComplete: function (e) {
              if (!0 !== e.returnValue) o({ errorCode: e.errorCode, errorText: e.errorText })
              else {
