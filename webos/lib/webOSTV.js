!(function () {
  ...
  var e = {
      d: function (n, t) {
        for (var o in t)
          e.o(t, o) && !e.o(n, o) && Object.defineProperty(n, o, { enumerable: !0, get: t[o] })
      },
      o: function (e, n) {
        ...
        (n = [
          {
            ...
            value: function (e) {
              ...
              if (!window.PalmServiceBridge) {
                ...
                return (d(g), p(g), console.error('PalmServiceBridge is not found.'), this)
              }
              ...
              return (
                ...
                (this.bridge.onservicecallback = this.callback.bind(this, a, d, p)),
                this.bridge.call(
                  ('/' !== (w = t).slice(-1) && (w += '/'), w + r),
                  JSON.stringify(b)
),
            ...
            value: function () {
              ...
              if (!this.cancelled) {
                ...
                var i = r,
                  s = i.errorCode,
                  u = i.returnValue
                ;(s || !1 === u ? ((r.returnValue = !1), n(r)) : ((r.returnValue = !0), e(r)),
                  t(r),
  ...
  function M(e) {
    ...
    'external_arc_sound_alive' !== k.soundOutput
      ? e(!0)
      : !k.soundOutput ||
          (0 !== k.soundOutput.indexOf('tv_') && 'external_arc_sound_alive' !== k.soundOutput)
        ? e(null)
        : e(!1)
  }
  function N(e) {
    'auto' === k.soundOutputDigital || 'passThrough' === k.soundOutputDigital ? e(!0) : e(!1)
  }
  function _(e, n) {
  ...
  function B(e) {
    !(function (e) {
      ;(P.sdkVersion && e(P.sdkVersion.split('.')),
        new m().send({
          service: 'luna://com.webos.service.tv.systemproperty',
          method: 'getSystemInfo',
          parameters: { keys: ['sdkVersion'] },
          onSuccess: function (n) {
            ;((P.sdkVersion = n.sdkVersion || P.sdkVersion), e(P.sdkVersion.split('.')))
          },
          onFailure: function () {
            e([0, 0, 0])
          }
      ...
      parseInt(n[0], 10) >= 5
        ? new m().send({
            ...
            onComplete: function (n) {
              M(function (t) {
                ;(t ||
                  (!k.dolbyAtmosConfig && 'tv_speaker_external_arc_harmony' === k.soundOutput)) &&
                  N(function (t) {
                    _(!!t && n.returnValue && ('ATMOS' === n.arcProfile || !0 === n.earcATMOS), e)
                  })
              })
            },
            onFailure: function () {
        ...
        : new m().send({
            ...
            onComplete: function (n) {
              M(function (t) {
                ;(!t &&
                  (k.dolbyAtmosConfig ||
                    ('tv_speaker_external_arc_harmony' !== k.soundOutput &&
                      void 0 !== k.soundOutput))) ||
                  N(function (t) {
                    _(!!t && n.returnValue && !0 === n.atmosDevice, e)
                  })
              })
            },
            onFailure: function () {
  ...
  function R(e) {
    void 0 === k.dolbyAtmosConfig
      ? new m().send({
          service: 'luna://com.webos.service.config',
          method: 'getConfigs',
          parameters: { configNames: ['tv.config.supportDolbyTVATMOS', 'tv.model.soundModeType'] },
          onComplete: function (n) {
            ;((k.dolbyAtmosConfig = n.configs
      ...
      : !0 === k.dolbyAtmosConfig
        ? _(!0, e)
        : !1 === k.dolbyAtmosConfig
          ? 'tv_speaker_external_arc_harmony' === k.soundOutput
            ? N(function (n) {
                n ? B(e) : _(!1, e)
              })
            : void 0 === k.soundOutput
              ? (console.log('[webOSTV.js] soundOutput value is', k.soundOutput), B(e))
              : _(!1, e)
          : (console.log('[webOSTV.js] dolbyAtmos config is', k.dolbyAtmosConfig), _(!1, e))
  }
  var z = function (e) {
      ;(!(function (e) {
        new m().send({
          ...
          parameters: { category: 'sound', keys: ['soundOutput', 'soundOutputDigital'] },
          subscribe: !0,
          onSuccess: function (n) {
            n.settings
              ? ((k.soundOutput = n.settings.soundOutput || k.soundOutput),
                (k.soundOutputDigital = n.settings.soundOutputDigital || k.soundOutputDigital),
                n.settings.soundOutput
                  ? ((k.soundOutput = n.settings.soundOutput),
                    M(function (n) {
                      n
                        ? N(function (n) {
                            n ? B(e) : _(!1, e)
          ...
          : ((j = !0),
            (function () {
              try {
                ...
                ;((P.modelName = e.modelName),
                  (P.version = e.platformVersion),
                  (P.versionMajor = e.platformVersionMajor),
                  (P.versionMinor = e.platformVersionMinor),
                  (P.versionDot = e.platformVersionDot),
                  (P.screenWidth = e.screenWidth),
                  (P.screenHeight = e.screenHeight))
              } catch (e) {
                P.modelName = 'webOS Device'
              }
              ;((P.screenHeight = P.screenHeight || window.screen.height),
                (P.screenWidth = P.screenWidth || window.screen.width))
            })(),
            T.tv
              ? ((P.uhd = !1),
                (P.uhd8K = !1),
                ...
                (P.dolbyVision = !1),
                (P.brandName = 'LG'),
                (P.manufacturer = 'LG Electronics'),
                (P.platformBizType = 'LG'),
                (P.tuner = !0),
                (function (e) {
                  new m().send({
                    service: 'luna://com.webos.service.config',
                    ...
                    onComplete: function (n) {
                      if (n.configs) {
                        if (
                          ((P.modelName = n.configs['tv.model.modelname'] || P.modelName),
                          ...
                          P.version = n.configs['tv.nyx.firmwareVersion']
                          for (
                            var t = P.version.split('.'),
                            ...
                            try {
                              P[o[r]] = parseInt(t[r], 10)
                            } catch (e) {
                              P[o[r]] = t[r]
                            }
                        }
                        ;((P.sdkVersion = n.configs['tv.nyx.platformVersion'] || P.sdkVersion),
                          (P.uhd =
                          ...
                          (P.oled = 'OLED' === n.configs['tv.hw.displayType']),
                          (P.ddrSize = n.configs['tv.hw.ddrSize']),
                          (P.hdr10 = !0 === n.configs['tv.model.supportHDR']),
                          (P.dolbyVision = !0 === n.configs['tv.config.supportDolbyHDRContents']),
                          (P.brandName = n.configs['tv.model.TVBrandName'] || P.brandName),
                          (P.manufacturer = n.configs['tv.model.TVManufacturer'] || P.manufacturer),
                          (P.mainboardMaker = n.configs['tv.model.mainboardMaker']),
                          n.configs['wee.platformBizType']
                            ? (P.platformBizType = n.configs['wee.platformBizType'])
                            : 'WEE' === n.configs['com.webos.app.home.uiStyle'] &&
                              (P.platformBizType = 'wee'),
                          n.configs['profile.list']
                            ? (P.tuner = !n.configs['profile.list'].includes('tunerless'))
                            : n.configs['com.webos.service.utp.supportTunerless'] && (P.tuner = !1))
                      }
                      !n.returnValue ||
                      (function (e) {
                        var n = [
                        ...
                        ? (function (e) {
                            new m().send({
                              ...
                              onComplete: function (n) {
                                if (
                                  ((P.modelName = n.modelName || P.modelName),
                                  (P.sdkVersion = n.sdkVersion || P.sdkVersion),
                                  (P.uhd = n.UHD ? 'true' === n.UHD : P.uhd),
                                  (P.oled = n.OLED ? 'true' === n.OLED : P.oled),
                                  (P.ddrSize = n.ddrSize || P.ddrSize),
